  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      <div>
        ...
        <p className="text-slate-400">Visão geral dos seus investimentos em ações</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, index) => {
          ...
          return (
            <div
              key={index}
              className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50 hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10 hover:-translate-y-1"
            >
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">{holding.quantity} cotas</p>
                  </div>
                </div>
            ...
            {marketIndices.map((index, i) => (
              <div key={i} className="flex items-center justify-between p-3 bg-slate-900/50 rounded-lg">
                <div>
                  ...
                  <p className="text-slate-400 text-sm">{index.value}</p>
                </div>
