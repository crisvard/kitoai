...
export default function BrokerPortfolio() {
  ...
  const allocation = [
    { type: 'Ações Brasil', percentage: 65, color: 'bg-green-500' },
    { type: 'ETF', percentage: 20, color: 'bg-blue-500' },
    { type: 'FIIs', percentage: 10, color: 'bg-purple-500' },
    { type: 'Caixa', percentage: 5, color: 'bg-slate-500' },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 shadow-lg shadow-green-500/20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-green-100 font-medium">Patrimônio Total</span>
          </div>
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
          ...
          <p className="text-slate-400 text-sm mt-4">Pior Performance</p>
