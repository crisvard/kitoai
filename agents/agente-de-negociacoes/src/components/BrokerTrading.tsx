  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      <div>
        ...
        <p className="text-slate-400">Comprar e vender ações na bolsa brasileira</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {popularStocks.map((stock) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center text-white font-bold text-sm">
        ...
        <div className="lg:col-span-2 bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
          ...
          {/* Tipo de Ordem */}
          <div className="mb-6">
            <label className="text-slate-400 text-sm mb-2 block">Tipo de Ordem</label>
          ...
          <div className="bg-slate-900/50 rounded-xl p-4 mb-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-400 text-sm">Petrobras PN</p>
              </div>
              <div className="text-right">
          ...
          {/* Quantidade */}
          <div className="mb-6">
            <label className="text-slate-400 text-sm mb-2 block">Quantidade</label>
            <input
              type="number"
              placeholder="0"
              className="w-full bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3 text-white text-xl focus:outline-none focus:border-green-500"
            />
            <p className="text-slate-400 text-xs mt-2">Mín: 1 ação | Máx: 10.000 ações</p>
          </div>

          {/* Preço Limitado */}
          {orderMode === 'limit' && (
            <div className="mb-6">
              <label className="text-slate-400 text-sm mb-2 block">Preço Limite (R$)</label>
              <input
                type="number"
                placeholder="0,00"
                className="w-full bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3 text-white text-xl focus:outline-none focus:border-green-500"
          ...
          <div className="bg-slate-900/50 rounded-xl p-4 mb-6">
            ...
            <div className="flex items-center justify-between mb-2">
              <span className="text-slate-400">Taxa de Corretagem</span>
              <span className="text-white font-medium">R$ 4,90</span>
            </div>
            <div className="flex items-center justify-between pt-2 border-t border-slate-700">
              <span className="text-white font-bold">Total</span>
              <span className="text-green-400 font-bold text-xl">R$ 4,90</span>
            </div>
          </div>
