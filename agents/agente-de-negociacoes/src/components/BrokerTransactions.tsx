  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      <div>
        ...
        <p className="text-slate-400">Todas as suas operações na bolsa</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-slate-400 text-sm">Total Operações</span>
          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-700/50">
                <th className="text-left text-slate-400 font-medium pb-4">Data</th>
                ...
                <th className="text-right text-slate-400 font-medium pb-4">Qtd</th>
                ...
                <th className="text-left text-slate-400 font-medium pb-4">Corretora</th>
                <th className="text-left text-slate-400 font-medium pb-4">Status</th>
              </tr>
            </thead>
            <tbody>
              {filteredTransactions.map((tx) => (
                <tr key={tx.id} className="border-b border-slate-700/30 hover:bg-slate-900/50 transition-colors">
