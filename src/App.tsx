...
import LawyerWebsitePage from './pages/LawyerWebsitePage';
...
import { SchedulerProvider } from './scheduler/contexts/SchedulerContext';
...
function AppContent() {
    ...
    return (
      <RouterProvider router={createBrowserRouter([
        ...
        },
        {
          ...
          element: <FacebookOAuthCallbackPage />,
        },
        {
          path: '*',
          element: <Login />,
  ...
  return (
    <RouterProvider router={createBrowserRouter([
      ...
      {
        path: '/lawyer-websites',
        element: (
          <PermissionsProvider>
            <PrivateRoute>
              <FranchiseProvider>
                <LawyerWebsitePageWrapper />
              </FranchiseProvider>
            </PrivateRoute>
          </PermissionsProvider>
        ),
...
function LawyerWebsitePageWrapper() {
  const navigate = useNavigate();
  ...
  return <LawyerWebsitePage onBack={handleBack} />;
}
