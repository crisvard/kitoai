    ...
    <div className={`group relative bg-[#2a2a2a] rounded-2xl p-8 border transition-all duration-300 hover:shadow-2xl hover:shadow-[#c4d82e]/10 hover:-translate-y-1 w-full aspect-square flex flex-col ${
      ...
      <div className="space-y-3">
        <button
          onClick={onConfigure}
          disabled={isLocked}
          className={`w-full flex items-center justify-center space-x-2 text-white py-3 rounded-xl transition-all duration-200 ${
            isLocked
              ? 'bg-gray-700 cursor-not-allowed opacity-70'
              : 'bg-[#3a3a3a] hover:bg-[#4a4a4a] hover:shadow-lg'
          }`}
        >
      ...
      {/* Active / blocked status text */}
      {isLocked ? (
        <div className="mt-4 text-center">
          <span className="inline-flex items-center space-x-2 text-red-400 text-sm font-medium">
        ...
        <div className="mt-4 text-center">
          <span className="inline-flex items-center space-x-2 text-orange-400 text-sm font-medium">
