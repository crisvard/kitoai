  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-[#c4d82e] to-[#b5c928] rounded-2xl p-6 shadow-lg shadow-[#c4d82e]/20">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 bg-black/20 rounded-xl backdrop-blur-sm">
              <PieChart className="text-black" size={24} />
            </div>
            <span className="text-black/70 font-medium">Valor Total</span>
          </div>
        ...
        <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl rounded-2xl p-6 border border-white/10">
          <p className="text-gray-400 mb-2">Ativos no Portfólio</p>
          <p className="text-2xl font-bold text-white mb-1">{holdings.length}</p>
          <span className="text-gray-400 text-sm">em 4 exchanges</span>
        </div>
      </div>
