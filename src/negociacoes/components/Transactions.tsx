  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      <div>
        ...
        <p className="text-gray-400">Acompanhe todas as suas operações</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl rounded-2xl p-6 border border-white/10"
          >
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="text-left text-gray-400 font-medium pb-4">Exchange</th>
                ...
                <th className="text-center text-gray-400 font-medium pb-4">Status</th>
                <th className="text-right text-gray-400 font-medium pb-4">Data</th>
              </tr>
            </thead>
            <tbody>
              {filteredTransactions.map((tx) => (
                ...
                >
                  ...
                  <td className="py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">{tx.name}</p>
                      </div>
                    </div>
                  </td>
                  <td className="py-4">
                    <span className="px-3 py-1 bg-white/5 rounded-full text-gray-300 text-sm">
                      {tx.exchange}
                    </span>
                  </td>
                  <td className="py-4 text-right text-white">{tx.amount}</td>
                  <td className="py-4 text-right text-gray-300">{tx.price}</td>
                  ...
                  <td className="py-4 text-right text-gray-400 text-sm">{tx.date}</td>
                </tr>
              ))}
            </tbody>
          </table>
