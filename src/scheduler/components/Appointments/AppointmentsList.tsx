...
export default function AppointmentsList({ refreshTrigger, onReschedule, selectedAppointment, selectedDate, onCloseFilter }: AppointmentsListProps) {
  ...
  const loadProfessionalAppointments = async () => {
    ...
    try {
      ...
      if (error) {
        console.error('❌ [AppointmentsList] Erro na consulta de agendamentos:', error);
        console.log('📊 [ProfessionalServicesList] Dados de services:', appointmentsData);
        if (error) {
          console.error('❌ [ProfessionalServicesList] Erro na consulta de services:', error);
      ...
      <div className="mb-6">
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105 ${filter === 'all'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105 ${filter === 'pending'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105 ${filter === 'confirmed'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105 ${filter === 'completed'
                ? 'bg-gradient-to-r from-[#c4d82e] to-[#b8d025] text-black shadow-lg'
                : 'bg-gradient-to-br from-white/10 to-white/5 text-gray-300 hover:text-white hover:bg-white/10 border border-white/20'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105 ${filter === 'cancelled'
