      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {!professional && (
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition ${chartView === 'professional'
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition ${chartView === 'day'
              ? 'bg-blue-600 text-white'
              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition ${chartView === 'month'
              ? 'bg-blue-600 text-white'
              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
            }`}
        >
          ...
          <div className="flex items-center gap-2 p-4 bg-gray-50 rounded-lg">
            <div className="flex gap-2">
              <button
                ...
                className={`px-3 py-1 rounded text-xs font-medium transition ${filterPeriod === 'day'
                    ? 'bg-blue-600 text-white'
              ...
              <button
                ...
                className={`px-3 py-1 rounded text-xs font-medium transition ${filterPeriod === 'week'
                    ? 'bg-blue-600 text-white'
                    : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50'
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1 rounded text-xs font-medium transition ${filterPeriod === 'month'
