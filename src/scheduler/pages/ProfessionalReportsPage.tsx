...
import ProfessionalCombinedReports from '../components/Reports/ProfessionalCombinedReports';
...
export default function ProfessionalReportsPage() {
  ...
  const [selectedView, setSelectedView] = useState<ReportView>('commissions');
      ...
      <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl border border-white/10 rounded-3xl p-4 mb-8">
        <div className="flex space-x-1">
          <button
            ...
            className={`hidden px-6 py-2 rounded-lg text-sm font-medium transition ${selectedView === 'overview'
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg text-sm font-medium transition ${selectedView === 'commissions'
              ? 'bg-[#c4d82e] text-black'
              : 'bg-white/5 text-gray-300 hover:bg-white/10'
              }`}
          >
